...
def main():
    ...
    # 变异级别
    # df.loc[:, 'mutation_level'] = df.loc[:, 'mutation_level'].map({0:'Tier 3', 1:'Tier 1', 2:'Tier 2'})
...
def deal_consequence_type(ele):
    mapping_dict = {'错义突变':'missense_variant',
                    ...
                    '终止密码子碱基替换突变': None,
                    '剪接受体单核苷酸突变':'splice_donor_variant',
                    '剪接受体缺失突变':'splice_donor_variant',
                    '剪接受体插入突变':'splice_donor_variant',
                    '剪接受体碱基替换突变':'splice_donor_variant',
                    'Splice acceptor base substitution':'splice_donor_variant',
                    '剪接供体单核苷酸突变':'splice_acceptor_variant',
                    'Splice donor single nucleotide mutation':'splice_acceptor_variant',
                    '剪接供体缺失突变':'splice_acceptor_variant',
                    '剪接供体插入突变':'splice_acceptor_variant',
                    '剪接供体碱基替换突变':'splice_acceptor_variant',
