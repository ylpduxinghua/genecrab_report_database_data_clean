...
def main():
    ...
    result_new = []
    for tuple in result:
        pd_l1_report_samples_table_id = tuple[0]
        ...
        tmp = [pd_l1_report_samples_table_id, reports_table_id, order_table_id, sample_id, sample_name,
            received_at, vitro_at, antibody, created_at, lot_number,
            lot_date_range]
    ...
    pd_l1_sample_info_sql = '''create table pd_l1_sample_information_clean_final (
        ...
        antibody varchar(255) not null comment '抗体名称',
    ...
    create_table(conn, 'pd_l1_sample_information_clean_final', pd_l1_sample_info_sql)
    conn.close()
    ...
    insert_sql = f'''insert into pd_l1_sample_information_clean_final (pd_l1_report_samples_table_id, 
        ...
        vitro_at, antibody, created_at, lot_number,
